...
export const fetchAllUser = createAsyncThunk("users/fetchAll", async (payload, thunkApi) => {
    try {
...
export const removeUser = createAsyncThunk("users/deleteUse", async (payload, thunkApi) => {
    try {
